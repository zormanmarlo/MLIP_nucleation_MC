...
class Config:
    def __init__(self, config_file):
        ...
        self.optional_params = ['body_file', 'max_rotation_angle', 'table_path']
    ...
    def _missing_parameters(self):
        ...
        # table_path is optional (not needed in debug_potential mode)
        if 'table_path' not in self.parameters:
            self.parameters['table_path'] = None
