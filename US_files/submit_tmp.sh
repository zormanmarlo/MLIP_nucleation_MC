#!/bin/bash -l
#SBATCH --job-name=32mer_100mM_US
...
cd ../
mpiexec -n 1 python simulation.py -jobname ../NaCl_jobs/100mM_nacl_US_biastest_2.5kappa_reverttest/32mer -config configs/nacl_us/100mM_nacl_32mer_dang_test.yaml -np 4 -multi_inputs -debug
