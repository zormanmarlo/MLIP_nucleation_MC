...
mpiexec -n 1 python simulation.py -jobname ../NaCl_jobs/150mM_adapUS_20mer_lowAVBMC_8mcs_smallTrans_0626 -config configs/150mM_dang_adapUS_20mer_lowAVBMC_smallTrans.yaml -np 8 -adapUS
