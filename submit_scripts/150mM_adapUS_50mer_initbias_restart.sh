...
mpiexec -n 1 python simulation.py -jobname ../NaCl_jobs/150mM_adapUS_50mer_initbias_new -config configs/150mM_dang_adapUS_50mer_initbias.yaml -np 8 -adapUS -restart
