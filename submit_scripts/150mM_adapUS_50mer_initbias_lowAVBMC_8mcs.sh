...
mpiexec -n 1 python simulation.py -jobname ../NaCl_jobs/150mM_adapUS_50mer_initbias_lowAVBMC_8mcs -config configs/150mM_dang_adapUS_50mer_initbias_lowAVBMC.yaml -np 8 -adapUS
